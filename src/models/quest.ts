// Tipos baseados no contrato QuestManager em Rust
...
export interface QuestType {
  ...
  value?: string; // Para TradeVolume e PoolPosition
  tokenAddress?: string; // Para TokenHold
  amount?: string; // Para TokenHold
}
