...
export class QuestController {
     ...
     */
    static async registerForQuest(req, res) {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) {
                ResponseHelper.error(res, 'ID da quest inválido');
            ...
            Logger.error('Erro ao registrar na quest', error);
            ResponseHelper.internalError(res);
        }
    }
    /**
     ...
     */
    static async getQuestParticipants(req, res) {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) {
                ResponseHelper.error(res, 'ID da quest inválido');
    ...
    static async checkUserRegistration(req, res) {
        try {
            ...
            Logger.error('Erro ao verificar registro', error);
            ResponseHelper.internalError(res);
        }
    }
    /**
     ...
     */
    static async cancelQuest(req, res) {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) {
                ResponseHelper.error(res, 'ID da quest inválido');
